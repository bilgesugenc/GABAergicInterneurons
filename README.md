...
protocols with the goal of achieving high percentage of GABAergic interneurons which can
...
a reproducible protocol which generates 80% GABAergic markers able to migrate in vitro.
